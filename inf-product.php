    ...
    <div class="detail-product">
        <div class="detail-product-container">
            <div class="detail-product-image">
				<img src="image/tp1.jpg" alt="" >
            </div>
            <div class="detail-product-inf">
                <h3>Black Handbag</h3>
				...
				<div class="evaluate-inf">
					<ul>
						...
						<li><a href="#"><i class="fa fa-gift"></i>Coupon</a></li>	
					</ul>
				</div>
				<p style="line-height: 25px;font-size:16px;float: left;text-align: justify;">Fusce a egestas nibh, eget ornare erat. Proin placerat, urna et consequat efficitur, sem odio blandit enim, sit amet euismod turpis est mattis lectus. Vestibulum maximus quam et quam egestas imperdiet. In dignissim auctor viverra.</p>
				<button class="btn"><i class="fa fa-cart-plus" style="margin-right: 10px;" ></i>Add to cart </button>
			</div>
			<div class="comment">
	...
	<div class="contact">
		<div class="container5">
			...
			<div class="inf-taikhoan">
				<h1>Account</h1>
				<ul>
					<li><br><a href="#">Login</a></li>
					<li><br><a href="#">Register</a></li>
